...
class AgentSecurityBlockerMerchantPortalGuiToSecurityBlockerClientBridge implements AgentSecurityBlockerMerchantPortalGuiToSecurityBlockerClientInterface
{
    /**
